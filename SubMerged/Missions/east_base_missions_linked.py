...
def EAST3(br: BaseRobot):
    ...
    while 15 < br.hub.imu.heading() < 19:
        br.drive(0, turn_rate=(17-br.imu.heading))
    br.stop()
    br.straight(10)
    # br.straight(-17, Stop.BRAKE)
    br.turn_attachment(br.back_attachment, 1000, 815, wait_time=100000)
    br.settings(turn_acceleration=200)
    br.hub.imu.reset_heading(0)
    br.turn(27, Stop.BRAKE)
    while 25 < br.hub.imu.heading() < 29:
        br.drive(0, turn_rate=(27-br.hub.imu.heading()))
    br.turn_attachment(br.back_attachment, 1000, -815, wait_time=100000)
    br.straight(-60, Stop.BRAKE)

    br.hub.imu.reset_heading(0)
    br.turn(-54.25, Stop.BRAKE)
    while -52.25 > br.hub.imu.heading() > 56.25:
        br.drive(0, turn_rate=(54.25-br.hub.imu.heading))
    br.straight(300)
