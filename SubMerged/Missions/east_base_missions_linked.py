if (not __name__ == "__main__"):
    ...
    def EAST3(br: BaseRobot)
        ...
        br.curve(8.25, 30, Stop.BRAKE)
        br.straight(10)
        # br.straight(-17, Stop.BRAKE)
        motor.front_attachment.run_angle(1000,-825, Stop.BRAKE)
        br.settings(turn_rate=50)
        br.turn(47, Stop.BRAKE)
        motor.front_attachmentrun_angle(1000,825, Stop.BRAKE)
        br.straight(-60)
        br.turn(-115)
        br.straight(300)
        motor.front_attachment.run_angle(1000,-150)
        br.turn(-30)
        br.straight(50)
        motor.front_attachment.run_angle(1000,-950)
else:
